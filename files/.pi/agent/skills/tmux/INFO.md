...
- **Source URL**: https://github.com/mitsuhiko/agent-stuff
- **Path in repo**: `skills/tmux/`
- **Git commit**: b502ee5a393755e857a2a5c5e8c6a507b6ad652f

## Files vendored

- `SKILL.md` — skill definition
- `scripts/find-sessions.sh` — list tmux sessions on a socket
- `scripts/wait-for-text.sh` — poll a tmux pane for a regex pattern
...
Apache License, Version 2.0
   ...
   1. Definitions.
      ...
      "Derivative Works" shall mean any work based on (or derived from)
      the Work for which the editorial revisions, annotations, elaborations,
   ...
   3. Grant of Patent License. Subject to the terms and conditions of
      ...
      lawsuit) alleging that the Work or a Contribution constitutes direct or
