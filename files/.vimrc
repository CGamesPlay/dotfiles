...
" We may need to create the cache directory.
if !isdirectory(expand("$XDG_CACHE_HOME/vim"))
  execute("!mkdir -p ".expand("$XDG_CACHE_HOME/vim"))
end

" Set where we store swap and backup files
set directory=$XDG_CACHE_HOME/vim//,~/,/tmp
set backupdir=$XDG_CACHE_HOME/vim,~/,/tmp
" Set where the vim history file gets stored
