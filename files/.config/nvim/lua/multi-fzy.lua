...
--
-- Then CGamesPlay made it better, by allowing multiple patterns.
...
-- Sorter using the multi fzy algorithm
function fzy.sorter(opts)
  opts = opts or {}
  opts.fzy_mod = fzy
